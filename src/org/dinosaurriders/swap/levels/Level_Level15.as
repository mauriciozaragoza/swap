...
import org.dinosaurriders.swap.*;import org.dinosaurriders.swap.objects.*;
	public class Level_Level15 extends BaseLevel
	{
		...
		public function addSpritesForLayerSprites(onAddCallback:Function = null):void
		{
			...
			addSpriteToLayer(new PolygonBody(160.000, 385.000, Assets.ForestBoulderLarge, 12, 2000), PolygonBody, SpritesGroup , 160.000, 385.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"swappable", value:true }, null ), onAddCallback );//"ForestBoulderLarge"
			...
			addSpriteToLayer(null, Player, SpritesGroup , 0.000, 864.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"swappable", value:true }, null ), onAddCallback );//"Player"
