...
import org.dinosaurriders.swap.*;import org.dinosaurriders.swap.objects.*;
	public class Level_Level14 extends BaseLevel
	{
		...
		public function addSpritesForLayerSprites(onAddCallback:Function = null):void
		{
			...
			linkedObjectDictionary[18] = addSpriteToLayer(new WeightSwitch(160.000, 88.000, Assets.Switch1, 100), WeightSwitch, SpritesGroup , 160.000, 88.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Switch1"
			...
			linkedObjectDictionary[19] = addSpriteToLayer(new WeightSwitch(96.000, 344.000, Assets.Switch1, 100), WeightSwitch, SpritesGroup , 96.000, 344.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Switch1"
			addSpriteToLayer(new PolygonBody(160.000, 320.000, Assets.SquareRock2, 4, 2500), PolygonBody, SpritesGroup , 160.000, 320.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"swappable", value:true }, null ), onAddCallback );//"SquareRock2"
