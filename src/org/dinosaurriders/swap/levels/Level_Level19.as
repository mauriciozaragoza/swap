...
import org.dinosaurriders.swap.*;import org.dinosaurriders.swap.objects.*;
	public class Level_Level19 extends BaseLevel
	{
		...
		public function addSpritesForLayerSprites(onAddCallback:Function = null):void
		{
			...
			linkedObjectDictionary[9] = addSpriteToLayer(new Exit(463.000, 400.000, Assets.Exit), Exit, SpritesGroup , 463.000, 400.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"sensor", value:true }, { name:"enabled", value:false }, { name:"warp", value:"Level20" }, null ), onAddCallback );//"Exit"
