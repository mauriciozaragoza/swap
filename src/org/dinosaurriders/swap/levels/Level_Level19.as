...
import org.dinosaurriders.swap.*;import org.dinosaurriders.swap.objects.*;
	public class Level_Level19 extends BaseLevel
	{
		...
		public function addSpritesForLayerSprites(onAddCallback:Function = null):void
		{
			...
			addSpriteToLayer(new PolygonBody(448.000, 514.000, Assets.Crate1, 4, 500), PolygonBody, SpritesGroup , 448.000, 514.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"swappable", value:false }, { name:"fixedx", value:true }, null ), onAddCallback );//"Crate1"
		}
