...
import org.dinosaurriders.swap.*;import org.dinosaurriders.swap.objects.*;
	public class Level_Level6 extends BaseLevel
	{
		...
		public function addSpritesForLayerSprites(onAddCallback:Function = null):void
		{
			...
			addSpriteToLayer(new PolygonBody(1530.000, 330.000, Assets.SquareRock1, 4, 2000), PolygonBody, SpritesGroup , 1530.000, 330.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"swappable", value:false }, { name:"fixedx", value:true }, { name:"friction", value:1.000000 }, null ), onAddCallback );//"SquareRock1"
